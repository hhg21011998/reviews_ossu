...
# Exerci, and (3) counting the ose 3: Use urllib to replicate the previous exercise of (1) retrieving the document from a URL,
# (2) displaying up to 3000 charactersverall number of characters in the document.
